...
##
*/
(function(c){function u(){c.body.classList.add("overflow-hidden");g.style.display="block";f.style.display="block";f.scrollTop=0;g.classList.add("in");setTimeout(function(){c.body.classList.add("modal-open")},50)}function v(){c.body.classList.remove("modal-open");setTimeout(function(){f.style.display="none";g.classList.add("fade");g.classList.remove("in");setTimeout(function(){g.style.display="none";c.body.classList.remove("overflow-hidden")},300)},300)}var l,p,w="am bn et fil gu hi hr kn lv ml mr sr sw ta te".split(" "),
q={ca:["color","contrast","controls","sepia","videos"],da:["loop","support","backup","sepia"],de:"autoplay backup export import loop_start playlists screenshot sepia stop videos".split(" "),el:["theme"],es:["color","sepia"],es_419:["color","sepia"],fr:["options","support","volume","stop","message"],id:"autoplay backup gaussian_blur reset screenshot sepia stop volume".split(" "),it:"backup loop mini_player playlists reset screenshot sepia volume".split(" "),ms:["import","sepia"],nl:"autoplay filters support contrast sepia variant volume".split(" "),
no:["loop_start","sepia","variant"],pl:["sepia"],pt_BR:["backup","mini_player","volume"],pt_PT:["backup","volume"],ro:["backup","gaussian_blur","contrast","sepia"],sl:["sepia"],sk:["message"],sv:["loop","support","sepia","variant"]},x=c.querySelectorAll("nav a"),y=c.querySelector("nav .donate a"),h=c.querySelector("#locale"),d=c.querySelectorAll("[contenteditable]"),m=c.querySelector("#generate-code-btn"),g=c.querySelector("#modal-backdrop"),f=c.querySelector("#modal"),z=f.querySelector(".modal-title"),
r=f.querySelector(".close-modal"),t=f.querySelector("#code"),A=f.querySelector("#copy-to-clipboard-btn"),n=f.querySelector("#copy-to-clipboard-checkmark");x.forEach(function(a){a.addEventListener("focus",function(){this.parentNode.classList.add("focus")});a.addEventListener("blur",function(){this.parentNode.classList.remove("focus")})});y.addEventListener("click",function(a){a.preventDefault();a=0>"bg cs da de el es et fi fr hr hu it lt lv nl pl pt_BR pt_PT ro sk sl sv".indexOf(chrome.i18n.getMessage("locale_code"))?
